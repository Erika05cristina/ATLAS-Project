// ============================================================
// A.T.L.A.S. — Provider Wallet
// Inicializa AtlasWallet con la semilla del Proveedor desde .env
// ============================================================
...
export function createProviderWallet(): AtlasWallet {
    const seed = getRequiredEnv("PROVIDER_SEED");
